...
Generated by `src/tables_paper.py` from `results/`; do not edit by hand. AUC: probability that a randomly chosen Zipfian dataset scores higher than a randomly chosen dataset of the alternative law. 0.5: no separation; below 0.5: ranked backwards.
...
| regime | alternative | mean R^2 | shuffled z | rotated z | bigram z |
|---|---|---|---|---|---|
...
| song | stickiness | alternative | mean R^2 | shuffled z | rotated z | bigram z | slope |
|---|---|---|---|---|---|---|---|
...
| regime | level | threshold | alternative | mean R^2 | shuffled z | rotated z | bigram z |
|---|---|---|---|---|---|---|---|
...
| regime | level | change | alternative | mean R^2 | shuffled z | rotated z | bigram z |
|---|---|---|---|---|---|---|---|
...
| regime | units | alternative | log-log R^2 | tail fraction | bootstrap p | likelihood ratio | exponent |
|---|---|---|---|---|---|---|---|

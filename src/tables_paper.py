...
C4_STATS = [("observed_mean_r2", "mean R^2"), ("shuffle_z", "shuffled z"), ("rotate_z", "rotated z"),
            ("bigram_z", "bigram z")]
...
def table_s5():
    ...
    stats = [("loglog_r2", "log-log R^2"), ("tail_fraction", "tail fraction"), ("gof_p", "bootstrap p"),
...
def main():
    ...
    parts = ["# Supplementary tables", "",
             "Generated by `src/tables_paper.py` from `results/`; do not edit by hand. AUC: probability that a randomly "
             "chosen Zipfian dataset scores higher than a randomly chosen dataset of the alternative law. 0.5: no "
             "separation; below 0.5: ranked backwards.", ""]
